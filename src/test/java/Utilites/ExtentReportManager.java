...
public class ExtentReportManager implements ITestListener {
	...
	public void onStart(ITestContext testContext) {
		...
		*/
		...
		extent.setSystemInfo("User Name", System.getProperty("user.name"));//display testre name who are using
	...
	public void onFinish(ITestContext testContext) {
		 ...
		 * email.setSSLOnConnect(true); email.setFrom("viswa.phvs@gmail.com"); //Sender
